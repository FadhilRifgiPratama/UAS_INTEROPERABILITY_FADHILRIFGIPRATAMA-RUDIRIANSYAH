                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="frontend-v2/img/image-1.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide" style="max-height: 500px">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Eksklusif</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="frontend-v2/img/image-2.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide" style="max-height: 500px">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Sporty</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="frontend-v2/img/image-5.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide" style="max-height: 500px">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6 col-lg-4 col-xl-4">
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Football</div>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-4">
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img src="frontend-v2/img/image-5.jpg" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Basket Ball</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Grapes</h4>
                                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
