                                             ...
                                             <div class="col-12 mt-1">
                                                 <div class="form-group">
                                                     <div class="controls">
                                                         ...
                                                         <input type="text" name="name" class="form-control" placeholder="Category Name" required data-validation-required-message="This Detail Location field is required">
                                                     </div>
                                                 </div>
                                             </div>
                                         </div>
